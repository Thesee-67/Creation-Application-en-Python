...
def server_shell(flag_lock, flag, clients,):
    ...
    while flag[0]:
        ...
        if commande.lower() == "kill":
            ...
            print("- accept@identifiant : Accepter une demande de changement de channel (Remplacer identifiant par l'identifiant concerné).")
            print("- refuser@identifiant : Refuser une demande de changement de channel(Remplacer identifiant par l'identifiant concerné).")
            print("- ban@identifiant : Bannir un client (Remplacer identifiant par l'identifiant concerné).")
            print("- kick@identifiant : Appliquer une sanction kick (bannir pendant 1h) (Remplacer identifiant par l'identifiant concerné).")
            print("- showban : Afficher la liste des clients bannis.")
            print("- showkick : Afficher la liste des clients kickés.")
            print("- unban@identifiant : Lever le ban d'un client (Remplacer identifiant par l'identifiant concerné).")
            print("- unkick@identifiant : Lever la sanction kick d'un client (Remplacer identifiant par l'identifiant concerné).")
